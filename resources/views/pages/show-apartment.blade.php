...
<div class="show-container">
    ...
    <div class="row">
        ...
        <div class="item services">
            ...
            <tomtommap name="{{ $apartment -> title }}" address="{{ $apartment -> address }}" class="tomTom"
                       :lat="{{ $apartment -> address_lat }}" :lon="{{ $apartment -> address_lon }}"
            ></tomtommap>
        </div>
    </div>
    <div class="row">
            ...
            <div class="msg">
                <div class="msg-body">
                  <form action="{{ route('store-message', $apartment->id) }}" method="post">
                    ...
                    <input type="email" name="mail" required class="email" placeholder="Scrivi la tua mail per essere ricontattato"
                      @auth 
